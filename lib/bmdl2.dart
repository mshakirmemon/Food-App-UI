...
class Bmdl2 extends StatefulWidget {

  @override
  State<Bmdl2> createState() => _Bmdl2State();
}

class _Bmdl2State extends State<Bmdl2> {
  @override
          ...
          Column(children: [
            SizedBox(height: 20,),
              Container(
                ...
                child: Center(child: Image.asset("assets/gola.png"))),
                  ...
                  Row(
                    children: [
                      ...
                      Text("1.  2 Gola Kabab", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      Padding(padding: EdgeInsets.only(left:10, top: 10),child: 
                      Text("2.  2 Pori Paratha", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      ...
                      Padding(padding: EdgeInsets.only(left:10, top: 10),child: 
                      Text("3.  500ml Cold Drink", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      Text("Price :  749", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ],),
