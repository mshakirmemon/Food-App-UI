...
class Bmdl3 extends StatefulWidget {
 

  @override
  State<Bmdl3> createState() => _Bmdl3State();
}

class _Bmdl3State extends State<Bmdl3> {
  @override
          ...
          Column(children: [
            SizedBox(height: 20,),
              Container(
                ...
                child: Center(child: Image.asset("assets/karai.png"))),
                  ...
                  Row(
                    children: [
                      ...
                      Text("1.  1KG Chicken Red Karai ", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      ...
                      Padding(padding: EdgeInsets.only(left:10, top: 10),child: 
                      Text("3.  1.5Ltr Cold Drink", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      Text("Price :  1199", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ],),
