...
import 'package:foodapp_by_shakir/fishbrdl.dart';
import 'package:foodapp_by_shakir/fishbritem.dart';
import 'package:foodapp_by_shakir/policy.dart';
import 'package:foodapp_by_shakir/sttng.dart';

class Fishbr extends StatefulWidget {

  @override
  State<Fishbr> createState() => _FishbrState();
}

class _FishbrState extends State<Fishbr> {
  @override
    ...
    return Scaffold(
      ...
      Column(
        ...
        Column(
          children: [
            InkWell(
              onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Fishbritem()));},
              child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        height: 150,
                        child: Image(image: AssetImage("assets/fingerfish.png"))),
        ...
        Column(
          children: [
            InkWell(
              onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Fishbrdl()));},
              child: Center(
                child: Container(
                  height: 200,
                  width: MediaQuery.of(context).size.width*0.90,
