...
import 'package:foodapp_by_shakir/italiandl.dart';
import 'package:foodapp_by_shakir/italianitem.dart';
    ...
    return Scaffold(
      ...
      Column(
        ...
        Column(
          children: [
            InkWell(
              onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Italianitem()));},
              child: Padding(
        ...
        Column(
          children: [
            InkWell(
              onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Italiandl()));},
              child: Center(
                child: Container(
                  height: 200,
                  width: MediaQuery.of(context).size.width*0.90,
