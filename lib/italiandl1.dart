...
class Italiandl1 extends StatefulWidget {

  @override
  State<Italiandl1> createState() => _Italiandl1State();
}

class _Italiandl1State extends State<Italiandl1> {
  @override
          ...
          Column(children: [
            SizedBox(height: 20,),
              Container(
                ...
                child: Center(child: Image.asset("assets/negates.png"))),
                  ...
                  Row(
                    children: [
                      ...
                      Text("1.  12 Negates", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      Padding(padding: EdgeInsets.only(left:10, top: 10),child: 
                      Text("2.  500ml Cold Drink", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      ...
                      Text("Price :  399", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ],),
