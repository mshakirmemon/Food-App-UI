...
class Italiandl2 extends StatefulWidget {

  @override
  State<Italiandl2> createState() => _Italiandl2State();
}

class _Italiandl2State extends State<Italiandl2> {
  @override
          ...
          Column(children: [
            SizedBox(height: 20,),
              Container(
                ...
                child: Center(child: Image.asset("assets/item.png"))),
                   Row(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Padding(padding: EdgeInsets.only(top:20),child: 
                      Text("Deal-2", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  SizedBox(height: 20,),
                  Row(
                    children: [
                      ...
                      Text("1.  2 Zingers", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      Padding(padding: EdgeInsets.only(left:10, top: 10),child: 
                      Text("1.  2 Broasts", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      ...
                      Text("Price :  849", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ],),
