...
class Italianitem extends StatefulWidget {

  @override
  State<Italianitem> createState() => _ItalianitemState();
}

class _ItalianitemState extends State<Italianitem> {
  @override
            ...
            Container(
              ...
              child: Center(
                child: InkWell(onTap: (){
                  ...
                  child: ListTile(leading: CircleAvatar(backgroundImage: AssetImage("assets/broast.png")),
                  title: Text("Chicken Broast Holf KG", style: TextStyle(fontWeight: FontWeight.bold),),
                  trailing: 
                  Text("499"),),
                ),
              ),
            ...
            width: MediaQuery.of(context).size.width*0.97,
              ...
              child: Center(
                child: InkWell(onTap: (){
                  ...
                  child: ListTile(leading: CircleAvatar(backgroundImage: AssetImage("assets/broast.png")),
                  title: Text("Chicken Broast 1 KG", style: TextStyle(fontWeight: FontWeight.bold),),
                  trailing: 
                  Text("899"),),
                ),
              ),
            ...
            width: MediaQuery.of(context).size.width*0.97,
              ...
              child: Center(
                child: InkWell(onTap: (){
                  ...
                  child: ListTile(leading: CircleAvatar(backgroundImage: AssetImage("assets/zingerd.png")),
                  title: Text("Chicken Double Zinger Burger", style: TextStyle(fontWeight: FontWeight.bold),),
                  trailing: 
                  Text("299"),),
                ),
              ),
            ...
            width: MediaQuery.of(context).size.width*0.97,
              ...
              child: Center(
                child: InkWell(onTap: (){
                  ...
                  child: ListTile(leading: CircleAvatar(backgroundImage: AssetImage("assets/zingerch.png")),
                  title: Text("Chicken Cheese Zinger Burger", style: TextStyle(fontWeight: FontWeight.bold),),
                  trailing: 
                  Text("269"),),
                ),
              ),
  ...
  showDialog(context: context, builder: (context){
                            return AlertDialog(
                              title: Center(child: Container(
                                ...
                                child: Center(child: Text("Italian Fast Food", style: TextStyle(decorationColor: Colors.red, fontWeight: FontWeight.bold, color: Colors.white,)))),),
                              content: Container(
