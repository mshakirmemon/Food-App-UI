...
import 'package:foodapp_by_shakir/livedl.dart';
import 'package:foodapp_by_shakir/liveitem.dart';
    ...
    return Scaffold(
      ...
      Column(
        ...
        Column(
          children: [
            InkWell(
              onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Liveitem()));},
              child: Padding(
        ...
        Column(
          children: [
            InkWell(
              onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Livedl()));},
              child: Center(
                child: Container(
                  height: 200,
                  width: MediaQuery.of(context).size.width*0.90,
