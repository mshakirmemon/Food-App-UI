...
class Livedl1 extends StatefulWidget {
  @override
  State<Livedl1> createState() => _Livedl1State();
}

class _Livedl1State extends State<Livedl1> {
  @override
          ...
          Column(
            children: [
              ...
              Container(
                  ...
                  child: Center(child: Image.asset("assets/roll.png"))),
              Row(
