...
class Livedl3 extends StatefulWidget {
  

  @override
  State<Livedl3> createState() => _Livedl3State();
}

class _Livedl3State extends State<Livedl3> {
  @override
                ...
                child: Center(child: Image.asset("assets/pizza.png"))),
                  ...
                  Row(
                    children: [
                      ...
                      Text("1.  2 Chicken Fajeta Medium Pizza", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
