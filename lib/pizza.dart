...
import 'package:foodapp_by_shakir/pizzadl.dart';
import 'package:foodapp_by_shakir/pizzaitem.dart';
    ...
    return Scaffold(
      ...
      Column(
        ...
        Column(
          children: [
            InkWell(
              onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Pizzaitem()));},
              child: Padding(
        ...
        Column(
          children: [
            InkWell(
              onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Pizzadl()));},
              child: Center(
                child: Container(
                  height: 200,
                  width: MediaQuery.of(context).size.width*0.90,
