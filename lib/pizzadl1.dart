// ignore_for_file: prefer_const_constructors, use_key_in_widget_constructors, prefer_const_literals_to_create_immutables, sized_box_for_whitespace, duplicate_ignore
...
class Pizzadl1 extends StatefulWidget {

  @override
  State<Pizzadl1> createState() => _Pizzadl1State();
}

class _Pizzadl1State extends State<Pizzadl1> {
  @override
          ...
          Column(children: [
            SizedBox(height: 20,),
              Container(
                ...
                child: Center(child: Image.asset("assets/pizza.png"))),
                  ...
                  Row(
                    children: [
                      ...
                      Text("1.  2 Large Pizza", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      ...
                      Text("Price :  1999", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ],),
