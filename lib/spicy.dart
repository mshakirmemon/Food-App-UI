...
import 'package:foodapp_by_shakir/spicydel.dart';
import 'package:foodapp_by_shakir/spicyitm.dart';
...
class Spicy extends StatefulWidget {
  ...
  @override
  _SpicyState createState() => _SpicyState();
}
    ...
    return Scaffold(
      ...
      Column(
        ...
        Column(
          children: [
            InkWell(
              onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Spicyitems()));},
              child: Padding(
        ...
        Column(
          children: [
            InkWell(
              onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Spicydeals()));},
              child: Center(
                child: Container(
                  height: 200,
                  width: MediaQuery.of(context).size.width*0.90,
