...
class Spicydl1 extends StatefulWidget {

  @override
  State<Spicydl1> createState() => _Spicydl1State();
}

class _Spicydl1State extends State<Spicydl1> {
  @override
          ...
          Column(children: [
            SizedBox(height: 20,),
              Container(
                ...
                child: Center(child: Image(image: AssetImage("assets/zinger.png")))),
                  ...
                  Row(
                    children: [
                      ...
                      Text("1.  6 Zingers", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      ...
                      Padding(padding: EdgeInsets.only(left:10, top: 10),child: 
                      Text("2.  1.5 Ltr Cold Drink", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      Text("Price :  1099", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ],),
