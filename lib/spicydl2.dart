...
class Spicydl2 extends StatefulWidget {

  @override
  State<Spicydl2> createState() => _Spicydl2State();
}

class _Spicydl2State extends State<Spicydl2> {
  @override
          ...
          Column(children: [
            SizedBox(height: 20,),
              Container(
                ...
                child: Center(child: Image(image: AssetImage("assets/pizza.png")))),
                  ...
                  Row(
                    children: [
                      ...
                      Text("1.  1 Large Pizza", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      Padding(padding: EdgeInsets.only(left:10, top: 10),child: 
                      Text("2.  2 Small Pizza", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      ...
                      Padding(padding: EdgeInsets.only(left:10, top: 10),child: 
                      Text("3.  1 Ltr Cold Drink", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      Text("Price :  1799", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ],),
