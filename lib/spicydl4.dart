...
class Spicydl4 extends StatefulWidget {

  @override
  State<Spicydl4> createState() => _Spicydl4State();
}

class _Spicydl4State extends State<Spicydl4> {
  @override
          ...
          Column(children: [
            SizedBox(height: 20,),
              Container(
                ...
                child: Center(child: Image(image: AssetImage("assets/roll.png")))),
                   Row(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Padding(padding: EdgeInsets.only(top:20),child: 
                      Text("Deal-4", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  SizedBox(height: 20,),
                  Row(
                    children: [
                      ...
                      Text("1.  4 Chicken Roll", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                  ...
                  Row(
                    children: [
                      ...
                      Text("Price :  449", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)),
                    ],
                  ),
                  ],),
